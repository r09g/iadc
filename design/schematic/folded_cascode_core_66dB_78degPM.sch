...
C_load = 1 pF} 1040 -260 0 0 0.3 0.3 {}
...
C {devices/ipin.sym} 1180 -710 0 0 {name=p2 lab=inp}
C {devices/ipin.sym} 1180 -690 0 0 {name=p3 lab=inn}
...
C {devices/opin.sym} 1170 -550 0 0 {name=p9 lab=opp}
C {devices/opin.sym} 1170 -530 0 0 {name=p10 lab=opn}
