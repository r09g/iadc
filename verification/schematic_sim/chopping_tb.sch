...
S {}
E {}
N 1660 -800 1720 -800 { lab=fbp}
N 1380 -800 1460 -800 { lab=c1r}
N 1380 -200 1460 -200 { lab=c2r}
N 1660 -200 1720 -200 { lab=fbn}
...
N 1560 -800 1660 -800 { lab=fbp}
N 1620 -200 1660 -200 { lab=fbn}
N 100 -510 170 -510 { lab=GND}
N 1380 -270 1380 -200 { lab=c2r}
N 1380 -400 1380 -370 { lab=#net1}
N 1380 -800 1380 -710 { lab=c1r}
N 1380 -610 1380 -580 { lab=#net1}
...
N 1380 -500 2120 -500 { lab=#net1}
N 170 -510 240 -510 { lab=GND}
N 240 -510 270 -510 { lab=GND}
N 640 -520 640 -480 { lab=icm}
N 640 -520 720 -520 { lab=icm}
N 720 -460 820 -460 { lab=in}
N 720 -580 820 -580 { lab=ip}
N 1380 -580 1380 -500 { lab=#net1}
N 1380 -500 1380 -400 { lab=#net1}
N 1720 -800 1780 -800 { lab=fbp}
N 1880 -800 1960 -800 { lab=in1}
N 1720 -200 1780 -200 { lab=fbn}
N 1880 -200 1950 -200 { lab=ip1}
N 1950 -200 1960 -200 { lab=ip1}
N 1880 -400 2040 -400 { lab=ip1}
N 1740 -400 1780 -400 { lab=fbp}
N 1740 -800 1740 -400 { lab=fbp}
N 1710 -640 1780 -640 { lab=fbn}
N 1700 -640 1710 -640 { lab=fbn}
N 1700 -640 1700 -200 { lab=fbn}
N 1880 -640 2040 -640 { lab=in1}
N 2120 -920 2190 -920 { lab=fbp}
N 1700 -920 2120 -920 { lab=fbp}
N 1700 -920 1700 -800 { lab=fbp}
N 2120 -70 2200 -70 { lab=fbn}
N 1700 -70 2120 -70 { lab=fbn}
N 1700 -200 1700 -70 { lab=fbn}
...
N 1120 -580 1120 -500 { lab=icm}
N 1120 -500 1120 -400 { lab=icm}
...
C {devices/vsource.sym} 640 -450 0 0 {name=V5 value=0.9}
C {devices/gnd.sym} 640 -420 0 0 {name=l130 lab=GND}
C {devices/vsource.sym} 720 -550 0 0 {name=V6 value="DC 0 SINE(0 0.5 1e3)"}
C {devices/vsource.sym} 720 -490 0 0 {name=V7 value="DC 0 SINE(0 0.5 1e3)"}
C {devices/lab_pin.sym} 820 -460 0 1 {name=l131 sig_type=std_logic lab=in}
C {devices/lab_pin.sym} 820 -580 0 1 {name=l132 sig_type=std_logic lab=ip}
C {devices/lab_pin.sym} 640 -520 0 0 {name=l14 sig_type=std_logic lab=icm}
...
C {devices/lab_pin.sym} 1120 -500 0 0 {name=l63 sig_type=std_logic lab=icm}
C {devices/lab_wire.sym} 1700 -800 0 1 {name=l64 sig_type=std_logic lab=fbp}
C {devices/lab_wire.sym} 1700 -200 0 1 {name=l65 sig_type=std_logic lab=fbn}
C {ota.sym} 2120 -580 2 1 {name=x1 VDD=VDD VSS=VSS}
