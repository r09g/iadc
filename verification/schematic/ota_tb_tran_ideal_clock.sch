...
N 1160 -650 1200 -650 { lab=inp}
N 1160 -590 1200 -590 { lab=inn}
...
C {devices/vsource.sym} 860 -650 0 0 {name=V10 value="0"}
C {devices/vsource.sym} 860 -590 0 0 {name=V1 value="0"}
...
C {devices/vsource.sym} 560 -700 0 0 {name=V5 value="DC 0 PULSE(1.8 0 99.5n 2n 2n 91.5n 195n)"}
...
C {devices/isource.sym} 1240 -930 0 0 {name=I1 value=30u}
...
C {devices/lab_wire.sym} 1160 -650 0 0 {name=l16 sig_type=std_logic lab=inp}
C {devices/lab_wire.sym} 1160 -590 0 0 {name=l17 sig_type=std_logic lab=inn}
